...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(ModItems.COALCONSTRUCT_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        withExistingParent(ModItems.LAMPBUG_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
    }
